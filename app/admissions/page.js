                ...
                <div className="bg-white rounded-xl shadow-2xl border-t-8 border-iis-gold overflow-hidden">
                    ...
                    {submitted ? (
                        <div className="p-16 text-center animate-fade-in-up">
                            ...
                            <h3 className="font-serif text-3xl font-bold text-iis-navy mb-4">Application Submitted Successfully!</h3>
                            <p className="text-slate-600 text-lg mb-8 max-w-lg mx-auto">
                                Thank you for choosing Ishwar International School. Our admission counselor will review your application and contact you shortly.
                            </p>
                            <button
                                onClick={() => window.location.reload()}
                                className="bg-iis-maroon text-white px-8 py-3 rounded-sm font-bold uppercase tracking-wider hover:bg-red-900 transition-colors shadow-lg inline-flex items-center gap-2"
                            >
